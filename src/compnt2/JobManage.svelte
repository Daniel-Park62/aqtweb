<script>
    ...
    async function handleFieldSave() {
        ...
        if (errorRows.length > 0) {
            alert(
                `${errorRows.join(", ")} 행에 필수 정보가 누락되었습니다.\n필드명(영문/한글)을 확인해주세요.`,
            );
...
>
    <div
        class="bg-white flex-1 flex flex-col border border-gray-300 rounded shadow overflow-hidden"
    >
        <div
        ...
        >
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <div class="flex gap-1 ml-2">
                    <button on:click={searchMessages} class=" transition">
                        조회
                    </button>
                    <button on:click={handleMessageAdd} class=" transition">
                        추가
                    </button>
                    <button on:click={handleMessageDelete} class="btn-delete">
                        삭제
                    </button>
                    <button on:click={handleMessageSave} class=" transition">
                        저장
                    </button>
                    <!--
            ...
            <table class="min-w-full">
                <thead>
                    <tr>
                        ...
                        <th style="width: 100px; min-width: 100px;"> 포맷 </th>
                        <th style="width: 100px; min-width: 100px;"> 방향 </th>
                            ...
                            <td>
                                ...
                                >
                                    ...
                                    {#each commHeaders as commHeader}
                                        <option value={commHeader.COMMHD_ID}
                                            >{commHeader.COMMHD_KR_NM}</option
                                        >
                                    {/each}
                                </select>
                            </td>
                            ...
                            <td>
                                ...
                                >
                                    ...
                                    {#each relMsgs as relMsg}
                                        <option value={relMsg.MSG_ID}
                                            >{relMsg.MSG_KR_NM}</option
                                        >
                                    {/each}
                                </select>
                            </td>
    ...
    >
        ...
        >
            ...
            <div class="flex gap-1">
                ...
                />
                <button on:click={handleFieldSearchTrigger}> 조회 </button>
                <button on:click={handleFieldAdd}> 추가 </button>
                <button on:click={handleFieldDelete} class="btn-delete">
                    삭제
                </button>
                <button on:click={handleFieldSave}> 저장 </button>
                <div class="w-px h-6 bg-gray-300 mx-1"></div>
                <!-- Separator -->
                <button on:click={handleFieldExcelUpload} class="btn-excel">
                    엑셀 업로드
                </button>
                <button on:click={handleFieldExcelDownload} class="btn-excel">
                    엑셀 다운로드
                </button>
            </div>
        </div>
            ...
            <table class="min-w-full">
                <thead>
                    <tr>
                        ...
                        <th class="w-10 hidden">업무명</th>
                        <th class="w-10 hidden">전문ID</th>
                        <th class="w-10 hidden">전문명</th>
                        <th class="w-10 hidden">전문필드ID</th>
                        <th>필드명(영문)</th>
                        <th>필드명(한글)</th>
                        <th>타입</th>
                        <th>자리수</th>
                        <th class="w-10 hidden">설명</th>
                        <th class="w-10 hidden">세그먼트</th>
                        <th>시작위치</th>
                        <th>깊이</th>
                        <th>반복횟수</th>
                        <th>순서</th>
                ...
                <tbody class="bg-white">
                    {#each fieldList as field, i}
                        ...
                        >
                            ...
                            <td
                                class="border-r border-gray-200 px-2 py-1 text-center hidden"
                            >
                                {field.APP_ID}
                            </td>
                            <td
                            ...
                            <td
                                class="border-r border-gray-200 px-2 py-1 text-left hidden"
                            >
                            ...
                            <td>
                                <select
                                    ...
                                    on:change={() => handleFieldChange(field)}
                                    class="w-16 h-full border-none focus:ring-0 bg-transparent text-center"
                                >
                                    <option value="" disabled
                                        >필수여부 선택</option
                                    >
                            ...
                            <td
                                class="border-r border-gray-200 px-2 py-1 text-left p-0"
                            >
                                <select
                                ...
                                >
                                    <option value="" disabled={field.DY_YN}
                                        >종류 선택</option
                                    >
                                    ...
                                    <option value="3"
                                        >3.날짜+시간(YYYY-MM-DD HH:MM:SS)</option
                                    >
                                    <option value="4"
                                        >4.일련번호(자동생성)</option
                                    >
